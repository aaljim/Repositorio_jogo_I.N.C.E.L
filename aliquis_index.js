...
//45
        {
            action: "ESSE É O ÚNICO MÉTODO QUE TEMOS PARA NÓS REBELAR COTRA ESTE MUNDO CRUEL! MORREMOS AQUI, E DEIXAMOS PARA OS QUE FICAREM ENCONTRAR UM SIGNIFCADO NAS NOSSAS VIDAS!",
            opt1: {
                text: "continuar",
                nextpoint: 46,
            },
...
//47
        {
            action: "Assim, após este emocionante discurso, todos vão a rumo de Bastilha.",
            opt1: {
                text: "continuar",
                nextpoint: 48,
            },
