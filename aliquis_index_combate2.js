...
function applyPoint(next) {
    ...
    if(point.action == "Você derrota mais um inimigo, e começa a ver que o treinamento não foi em vão."){
...
setTimeout(() => {
    ...
    if(point.opt1.text == "Batalhar"){
        option1_bt.setAttribute("onclick", "window.location = 'battle_tests_batalha3.html'");
    };
